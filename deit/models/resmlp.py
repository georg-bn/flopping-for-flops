...
__all__ = [
    'resmlp_12', 'resmlp_24', 'resmlp_36', 'resmlpB_24', 'resmlpL_24'
]
...
class resmlp_models(nn.Module):
    ...
    def __init__(self,
        ...
        self.blocks = nn.ModuleList([
            layers_scale_mlp_blocks(dim=embed_dim,
                                    drop=drop_rate,
                                    drop_path=dpr[i],
                                    act_layer=act_layer,
...
def resmlpB_24(pretrained=False,dist=False, in_22k = False, **kwargs):
    model = resmlp_models(
        # patch_size=8,
        patch_size=16,  # 16 is better according to paper, and less compute intensive!
...
# Reasonable tradeoff in terms of parameters vs. ViT-L
# Parameters: 
# resmlp_L = 318m vs ViT_L = 304m  
# resmlp_B = 116 vs ViT_B = 87m
@register_model
def resmlpL_24(pretrained=False,dist=False, in_22k = False, **kwargs):
    model = resmlp_models(
        # patch_size=8,
        patch_size=16,  # 16 is better according to paper, and less compute intensive!
