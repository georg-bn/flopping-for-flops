...
def parse_args():
    ...
    parser.add_argument("--tgpu", default="A100", type=str, help="The type of the gpu. Defaults to A100.")
    parser.add_argument("--time", default="0-05:00:00", type=str, help="Duration of the job")
    ...
    parser.add_argument("--partition", default="alvis", type=str, help="Partition where to submit")
...
class Trainer(object):
    ...
    def checkpoint(self):
        ...
        self.args.dist_url = get_init_file(self.args.partition).as_uri()
...
def main():
    ...
    # I recommend setting the data_path here so you don't have to include it in all your jobs
    ...
    executor.update_parameters(
        ...
        slurm_additional_parameters={  
            "gpus-per-node": args.tgpu+":"+str(num_gpus_per_node),
            "time": args.time,
            
            # Add your slurm account here if needed
            # "account": account,
        },
        **kwargs
    )
    ...
    args.dist_url = get_init_file(partition).as_uri()
